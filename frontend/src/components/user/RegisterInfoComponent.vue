      ...
      <div class="flex items-center mb-5">
        ...
        <div class="w-3/4 gird grid-cols-2 gap-6 flex h-10">
          ...
          <button
            type="button"
            @click="codeSend()"
            class="text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-2 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center "
          >
            인증전송
          </button>
        </div>
