    ...
    <div id="profile" class="w-1/3 sticky top-0">
      ...
      >
        ...
        <button
          type="button"
          @click="goToLevel"
          class="text-white justify-center mt-5 bg-theme-red hover:bg-theme-redbrown focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center"
        >
          레벨 재측정
          <svg
    ...
    <div id="badge" class="w-2/3 flex flex-col items-center justify-center">
      ...
      <div class="flex-container relative z-10 items-center justify-center">
        <div
          ...
          :key="index"
          class="relative flex-item items-center justify-center mb-8"
        ...
        >
          ...
          >
            <div
              class="absolute -top-20 -left-5 z-30 w-max h-fit text-sm font-light text-gray-500 bg-gray-200 rounded-lg border border-gray-200 shadow-sm duration-300 dark:text-gray-400 dark:border-gray-600 dark:bg-gray-800"
            >
              <div
